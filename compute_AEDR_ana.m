function [AEDR_sig, AEDR_t] = compute_AEDR_ana(EDR_sig, fs, fc, plotflag)
%COMPUTE_AEDR_ANA   Compute analytic amplitude-estimation method
...
%         AEDR_t = time vector for AEDR signal
    ...
    [Me, me] = envelope(EDR_sig, round(10*fs), 'analytic');
